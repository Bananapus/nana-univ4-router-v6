...
- If you touch sell-side routing, verify preview failures and locally unfulfillable cash-out previews still degrade to V4 instead of reviving the older static reclaim estimate.
